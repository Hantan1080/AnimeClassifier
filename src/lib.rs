// src/lib.rs
/*
 * Core library for AnimeClassifier
 */
...
#[derive(Debug)]
pub struct AnimeClassifierProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeClassifierProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeClassifier processing");
    
    let mut processor = AnimeClassifierProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeClassifierProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeClassifierProcessor::new(false);
